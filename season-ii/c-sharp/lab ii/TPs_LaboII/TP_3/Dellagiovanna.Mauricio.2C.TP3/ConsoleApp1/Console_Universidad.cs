...
namespace Console_Universidad
{
    class Console_Universidad
    {
        static void Main(string[] args)
        {
            ...
            Alumno a1 = new Alumno(1, "Juan", "Lopez", "12234456",
                        ClasesAbstractas.Persona.ENacionalidad.Argentino, Universidad.EClases.Programacion, Alumno.EEstadoCuenta.Becado);
            ...
            try
            {
                Alumno a2 = new Alumno(2, "Juana", "Martinez", "12234458",
                                        ClasesAbstractas.Persona.ENacionalidad.Extranjero, Universidad.EClases.Laboratorio, Alumno.EEstadoCuenta.Deudor);
            ...
            try
            {
                Alumno a3 = new Alumno(2, "Jose", "Gutierrez", "12234456",
                                        ClasesAbstractas.Persona.ENacionalidad.Argentino, Universidad.EClases.Programacion, Alumno.EEstadoCuenta.Becado);
